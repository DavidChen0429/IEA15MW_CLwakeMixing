...
LiDAR_x = 3*D_IEA15MW;   % Definition of x is pointing downwind
LiDAR_y = 0;
...
for i = 1:1:simTime
    ...
    % !!!!!!!!! Control corresponding to Mtilt and Myaw
...
save('.\Data\MAT\IEA15_Helix_CCW_Str0.3_U8_Uni_600s_3Dd_1Hz_windspeedData.mat', 'LiDAR_data');
toc 
