...
fileName = ['2Turbines_OL_Helix_', windtype,'_mag', num2str(mag),'.mat'];
QprName = ['2Turbines_OL_Helix_',windtype,'_mag', num2str(mag),'.qpr'];
...
for i = 1:1:simTime
    ...
    % Low pass filter
    % Centering
    centerZ = wakeCenter(1) - meanZ;  % 89.6183
    centerY = wakeCenter(2) - meanY;  % -3.9836
%     centerZ = wakeCenter(1) - 89.6183;  % based on Baseline shear
%     centerY = wakeCenter(2) + 3.9836;   % based on Baseline shear
