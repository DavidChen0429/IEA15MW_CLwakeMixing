...
%% Data file 
fileName = '600s_Center_HF_tilt,bias.mat';
...
sigYaw_e = -2 * ones(simTime, 1);   % basic
...
templateStruct = struct('x', [], 'y', [], 'z', [], 'u_x', [], 'u_y', [], 'u_z', [], 'u_norm', [], 'u_los', [], 'centerY', [], 'centerZ', []);
...
for i = 1:1:simTime
    ...
    thetaTiltYaw = invR_helix * [0; 
                                 theta_tilt_e; 
                                 theta_yaw_e];    
    thetaBlade_Helix = invMBC * [thetaTiltYaw(1); 
                                 thetaTiltYaw(2); 
                                 thetaTiltYaw(3)];    
