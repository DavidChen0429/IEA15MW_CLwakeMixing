...
fileName = ['2Turbines_CL_Helix_', windtype,'_mag', num2str(mag),'_4D.mat'];
QprName = ['2Turbines_CL_Helix_',windtype,'_mag', num2str(mag),'_4D.qpr'];
...
for i = 1:1:simTime
    ...
    % Low pass filter
    % Centering
    centerZ = wakeCenter(1) - meanZ;  % 91.3572
    centerY = wakeCenter(2) - meanY;  % -3.9432
