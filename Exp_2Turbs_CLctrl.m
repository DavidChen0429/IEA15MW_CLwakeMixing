...
caseName = 'Experiment\Str0.3_U10_1Dd_10Hz_CCW\2TurbinesLonger\'; % 2 for testing
fileName = ['2Turbines_CL_Helix_',referenceType,'_mag', num2str(mag),'_4D_1inflowAngle.mat'];
