...
fileName = '1Turbines_CL_Helix_SISO_PI_mag3_ramp.mat';
QprName = '1Turbines_CL_Helix_SISO_PI_mag3_ramp.qpr';
...
% Create reference
r = referenceGenerator(simTime,Trigger,(simTime*4)/5,'ramp&stop',3,1);
